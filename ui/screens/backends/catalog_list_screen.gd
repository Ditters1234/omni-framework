...
@onready var _currency_host: VBoxContainer = $MarginContainer/PanelContainer/VBoxContainer/MainContent/SidebarScroll/Sidebar/CurrencyHost
...
func _refresh_state() -> void:
	...
	_title_label.text = str(view_model.get("title", "Catalog Vendor"))
