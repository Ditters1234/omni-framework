...
- Keep our docs/ updated as edits happen. Docs in the base ./docs/ folder should be "this is what exists now" documents without reference to history or future plans. ./docs/TODO/ is for implementing and to-do work.
