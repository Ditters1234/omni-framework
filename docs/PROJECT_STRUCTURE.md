...
- `EntitySheetBackend` powers the character menu, including stats, equipment, quests, reputation, progress, activity, and a searchable/filterable inventory browser with equipment handoff.
