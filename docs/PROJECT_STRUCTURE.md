...
- `EntitySheetBackend` powers the character menu, including stats, equipment, quests, reputation, progress, activity, a searchable/filterable inventory browser, data-authored usable inventory items, direct equip from data-derived socket/tag compatibility, discard actions for loose inventory, and equipment handoff.
