...
- `EntitySheetBackend` powers the character menu, including stats, equipment, quests, reputation, progress, activity, a searchable/filterable inventory browser, data-authored usable inventory items, and equipment handoff.
