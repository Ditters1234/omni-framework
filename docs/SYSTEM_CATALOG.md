...
| `TaskProviderBackend` | `ui/screens/backends/task_provider_screen.tscn` | Faction ID, contract list | Faction contract board that starts quest templates from `faction.quest_pool`, with optional cached AI flavor text. | [`modding_guide.md`](modding_guide.md) |
...
| `OwnedEntitiesBackend` | `ui/screens/backends/owned_entities_screen.tscn` | Optional owner entity and assignment defaults | Owned-entity management surface with inspect, equipment, location dispatch, recall, and contract-assignment handoffs. | [`modding_guide.md`](modding_guide.md) |
