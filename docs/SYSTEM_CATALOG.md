...
| `EntitySheetBackend` | `ui/screens/backends/entity_sheet_screen.tscn` | Optional entity target and display flags | Entity stats, currency balances, equipment, data-driven inventory use/equip/discard actions, and faction standing. | [`modding_guide.md`](modding_guide.md) |
