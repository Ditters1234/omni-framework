...
- New games now open on the normal location surface rather than the character sheet, and start-action boards default to currently available activities instead of locked/upcoming previews.
