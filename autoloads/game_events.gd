...
const SIGNAL_CATALOG := {
	...
	"game_state": [
		...
		{"name": "entity_lifecycle_state_changed", "args": ["entity_id", "rule_id", "state_flag", "active"]},
...
signal entity_lifecycle_state_changed(entity_id: String, rule_id: String, state_flag: String, active: bool)
