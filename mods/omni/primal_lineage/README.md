...
This addon expands Vanguard University with a small physical transformation line.
...
This addon includes local placeholder sprites and sounds under `assets/`. They are copied from the current Vanguard base placeholders so the addon has every referenced file in its own folder while final art and audio are still in progress.
